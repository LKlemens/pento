defmodule PentoWeb.FAQLive.FormComponent do
  ...
  def update(%{faq: faq} = assigns, socket) do
    changeset = Questions.change_faq(faq)
  ...
  def handle_event("validate", %{"faq" => faq_params}, socket) do
    changeset =
      socket.assigns.faq
      |> Questions.change_faq(faq_params)
  ...
  defp save_faq(socket, :edit, faq_params) do
    case Questions.update_faq(socket.assigns.faq, faq_params) do
      {:ok, _faq} ->
        {:noreply,
         socket
  ...
  defp save_faq(socket, :new, faq_params) do
    case Questions.create_faq(faq_params) do
      {:ok, _faq} ->
        {:noreply,
         socket
